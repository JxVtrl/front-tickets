          ...
          <form className='register-form' onSubmit={handleSubmit(onSubmit)}>
            ...
            <input
              ...
              {...register('password', { 
                ...
                pattern: { value: passwordRegex, message: 'A senha deve conter pelo menos um número e um caractere especial' }
              })}
            />
            ...
            <input
              ...
              className='register-form-input'
              type="password"
              {...register('confirmPassword', { required: 'Confirmação de senha é obrigatória', validate: validatePassword })}
            />
